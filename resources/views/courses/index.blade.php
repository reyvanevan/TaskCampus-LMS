                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="text-lg font-medium text-gray-900">{{ $courses->where('status', 'active')->count() }}</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="text-lg font-medium text-gray-900">{{ $courses->where('status', 'inactive')->count() }}</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    <dt class="text-sm font-medium text-gray-500 truncate">Archived Courses</dt>
                                    <dd class="text-lg font-medium text-gray-900">{{ $courses->where('status', 'archived')->count() }}</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                ...
                <div class="p-6">
                    <form method="GET" action="{{ route('courses.index') }}" class="flex flex-wrap gap-4">
                        <div class="flex-1 min-w-0">
                            ...
                            <select name="semester" id="semester" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                        ...
                        @if(request()->hasAny(['semester', 'status']))
                            <div class="flex items-end">
                                <a href="{{ route('courses.index') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-gray-50 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                    Clear
                                </a>
                            </div>
                        @endif
            ...
            @else
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-center">
                        ...
                        <p class="text-sm text-gray-500 mb-4">Get started by creating a new course.</p>
